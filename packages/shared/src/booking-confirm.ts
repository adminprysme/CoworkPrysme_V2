...
export const BOOKING_CONFIRM_ERROR_CODES = {
  ...
  /** Staff-deactivated client account — same code as CLIENT_ACCOUNT_AUTH_ERROR_CODES. */
  ACCOUNT_LOCKED: "ACCOUNT_LOCKED",
  /**
   * Devis staff-accept bootstrap — password not set yet.
   * Distinct from ACCOUNT_LOCKED — never collapse both into one message.
   */
...
export const BookingConfirmErrorResponseSchema = z.object({
  code: z.enum([
    ...
    BOOKING_CONFIRM_ERROR_CODES.ACCOUNT_LOCKED,
    BOOKING_CONFIRM_ERROR_CODES.ACCOUNT_PENDING_ACTIVATION,
